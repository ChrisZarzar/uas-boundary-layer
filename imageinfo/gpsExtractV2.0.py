...
def get_gps_info(exif_data):
    ...
    gps_latitude = _get_if_exist(exif_data, 'GPS GPSLatitude').values
    gps_latitude_ref = _get_if_exist(exif_data, 'GPS GPSLatitudeRef').values
    gps_longitude = _get_if_exist(exif_data, 'GPS GPSLongitude').values
    gps_longitude_ref = _get_if_exist(exif_data, 'GPS GPSLongitudeRef').values
    gps_altitude = _get_if_exist(exif_data, 'GPS GPSAltitude').values
    gps_altitude_ref = _get_if_exist(exif_data, 'GPS GPSAltitudeRef').values
